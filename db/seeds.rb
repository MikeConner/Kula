...
# Fees
jetBlue.kula_fees.create!(:us_charity_rate => 0.1, :us_charity_kf_rate => 0.0225, :intl_charity_rate => 0.1, :intl_charity_kf_rate => 0.085)
...
milepoint.kula_fees.create!(:us_charity_rate => 0.1, :us_charity_kf_rate => 0.0225, :intl_charity_rate => 0.1, :intl_charity_kf_rate => 0.085)
redRobin.kula_fees.create!(:us_charity_rate => 0.1, :us_charity_kf_rate => 0.025, :us_school_rate => 0.1, :us_school_kf_rate => 0.025)
kula.kula_fees.create(:us_charity_rate => 0.1, :us_charity_kf_rate => 0.025, :us_school_rate => 0.1, :us_school_kf_rate => 0.025, :intl_charity_rate => 0.1, :intl_charity_kf_rate => 0.085)
kula.kula_fees.create(:distributor_identifier => 12, :distributor_rate => 0, :us_charity_rate => 0.1, :us_charity_kf_rate => 0.025, :us_school_rate => 0.1, :us_school_kf_rate => 0.025, :intl_charity_rate => 0.1, :intl_charity_kf_rate => 0.085)
...
kula.kula_fees.create(:distributor_identifier => 17, :distributor_rate => 0, :us_charity_rate => 0.1, :us_charity_kf_rate => 0.025, :us_school_rate => 0.1, :us_school_kf_rate => 0.025, :intl_charity_rate => 0.1, :intl_charity_kf_rate => 0.085)
